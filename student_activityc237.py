...
try:
    ...
    mustang_car_spawn_point = (world.get_map().get_spawn_points()[3])  # set spawn point here
    ...
    def _Radar_callback(data):
        ...
        for x in data:
            ...
            car_distance = ([[throttle, distance_data['distance']]])
            predictions = model.predict(car_distance)
            ...
            if result == 1:
                ...
                dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.5))
                print('Your Model Took Decision To Go STRAIGHT Since Predicton Is 2')
