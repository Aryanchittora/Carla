...
def carControl():
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.52, steer=-1.5, gear=0))
    time.sleep(5)
...
try:
    ...
    location = dropped_vehicle.get_location()
    print('Present Car Location :' + str(location))
    ...
    car = carControl()
    print('New Car Location :' + str(car))
