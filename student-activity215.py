...
def generate_lidar_blueprint(blueprint_library):
    lidar = blueprint_library.find('sensor.lidar.ray_cast_semantic')
    lidar.set_attribute('channels', str(64))
    lidar.set_attribute('points_per_second', str(500000))
    lidar.set_attribute('rotation_frequency', str(40))
    lidar.set_attribute('range', str(100))
    lidar.set_attribute('upper_fov', str(15))
    lidar.set_attribute('lower_fov', str(-25))
    return lidar
