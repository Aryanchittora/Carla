...
def number_of_vehicle():
    ...
    if len(all_vehicles) > 1:
        ...
        for x in all_vehicles: #complete this code
            if x.id != world.id: #complete this code
        ...
        for distance, vehicle in sorted_vehicles: #complete this code
            if distance > 200: #complete this code
                break
...
def car_control():
    ...
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam | carla.VehicleLightState.RightBlinker | carla.VehicleLightState.Interior))  #Turn on LowBeam light
    time.sleep(1)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.4)) 
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam | carla.VehicleLightState.Interior)) #Turn on LowBeam light
    time.sleep(3)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake=True))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.Brake | carla.VehicleLightState.LowBeam | carla.VehicleLightState.Interior)) #Turn on Brake light
    time.sleep(5)

    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam | carla.VehicleLightState.Interior))
    time.sleep(1)
