...
def generate_radar_blueprint(blueprint_library):
    ...
    radar.set_attribute('vertical_fov', str(10))
    radar.set_attribute('horizontal_fov', str(10))
    radar.set_attribute('points_per_second', str(15000))
    radar.set_attribute('range', str(10))
    return radar
...
try:
    ...
    def _Radar_callback(data):
        distance_data = {}
        for x in data:
            distance_data['distance'] = x.depth

        print("Distance -", distance_data['distance'])
