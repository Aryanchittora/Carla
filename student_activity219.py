...
def semantic_data(point_cloud):
    ...
    for x in point_cloud:
        ...
        distance_name['name'] = key_list[pos]
        print('Distance & Name Of Surroundings - ', distance_name)
...
try:
    ...
    sensor.listen(lambda point_cloud : semantic_data(point_cloud))
