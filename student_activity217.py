...
try:
    ...
    def _Radar_callback(radar_data):
        radarRotation = radar_data.transform.rotation
        radarVelocity = 7.5
        debug = world.debug
        for detect in radar_data:
            ...
            newPitch = radarRotation.pitch + radar_altitude
            newYaw = radarRotation.yaw + radar_azimuth
            newRoll = radarRotation.roll
